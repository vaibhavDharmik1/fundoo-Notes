...
router.post('', _user.newNoteValidator, _auth.userAuth, noteController.create); // Retrieve all Notes

router.get('', noteController.getAllNotes); // Retrieve a single Note with noteId

router.get('/:_id', noteController.getSingleNote); // Update a Note with noteId

router.put('/:_id', noteController.updateNote); // Delete a Note with noteId
